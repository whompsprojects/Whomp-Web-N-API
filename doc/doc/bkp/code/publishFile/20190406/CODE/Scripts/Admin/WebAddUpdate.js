...
var WDAd = {
    ...
    GatherHdrData: function () {
        try {
            ...
            VrWDHdr.Facilities_Desc = $('#span_Facilities_Desc').html(); VrWDHdr.Packages_Hdr_Desc = $('#span_Packages_Hdr_Desc').html(); VrWDHdr.Partner_Hdr_Desc = $('#span_Partner_Hdr_Desc').html();
