...
! function(a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        cellWidth: function() {
            var
                a = $("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),
        ...
        gridUnload: function(a) {
            if (a) {
                ...
                if (b.grid) {
                    ...
                    var
                        e = $.jgrid.jqID(b.id);
                    $(d).removeClass("ui-jqgrid-btable").insertBefore("#gbox_" + e), 1 === $(b.p.pager).parents("#gbox_" + e).length && $(b.p.pager).insertBefore("#gbox_" + e), $.jgrid.clearBeforeUnload(a), $("#gbox_" + e).remove(), $(d).attr({
                        id: c.id
        ...
        return this.each(function() {
            if (!this.grid) {
                    ...
                    e = {
                        ...
                        dragEnd: function() {
                            if (this.hDiv.style.cursor = "default", this.resizing) {
                                var
                                    a = this.resizing.idx,
                                    b = this.headers[a].newWidth || this.headers[a].width;
                ...
                var
                    h = $("<div class='ui-jqgrid-view' role='grid'></div>"),
                    i = $.jgrid.msie;
                ...
                $(j).attr({
                    id: "gbox_" + this.id,
                    dir: g
                }).insertBefore(h), $(h).attr("id", "gview_" + this.id).appendTo(j), $("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").insertBefore(h), $("<div class='loading ui-state-default ui-state-active' id='load_" + this.id + "'>" + $.jgrid.getRegional(d, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(h), $(this).attr({
                    cellspacing: "0",
                    cellpadding: "0",
                    border: "0",
                    role: "presentation",
                ...
                var
                    ...
                    r = function(a, b, c, e) {
                        var
                            f = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" class="cbox" name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>",
                            g = n(b, c, "", null, a, !0);
                        return '<td role="gridcell" ' + g + ">" + f + "</td>"
                    },
                    s = function(a, b, c, d) {
                        var
                            e = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b,
                            f = n(a, b, e, null, b, !0);
                    ...
                    w = function() {
                        var
                            ...
                            v = m.scroll ? $.jgrid.randId() : 1;
                        if ("local" === m.datatype && p.repeatitems === !0)
                            for (j = u(s), k = t("local"), e = m.keyIndex === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex, a = 0; o > a; a++) {
                                for (c = n[a], f = $.jgrid.getAccessor(c, e), void 0 === f && ("number" == typeof e && null != q[e + s] && (f = $.jgrid.getAccessor(c, q[e + s].name)), void 0 === f && (f = v + a, r && (g = $.jgrid.getAccessor(c, r) || c, f = null != g && void 0 !== g[e] ? g[e] : f, g = null))), i = {}, i[p.id] = f, r && (c = $.jgrid.getAccessor(c, r) || c), l = $.isArray(c) ? j : k, b = 0; b < l.length; b++) h = $.jgrid.getAccessor(c, l[b]), i[q[b + s].name] = h;
                                $.extend(!0, n[a], i)
                            }
                    },
                    x = function() {
                    ...
                    y = function(a, b, c, e, f, g) {
                        var
                            ...
                            j = "",
                            k = b ? "display:none;" : "",
                            l = "ui-widget-content jqgrow ui-row-" + d.p.direction + (c ? " " + c : "") + (g ? " ui-state-highlight" : ""),
                            m = $(d).triggerHandler("jqGridRowAttr", [e, f, a]);
                        if ("object" != typeof m && (m = $.isFunction(d.p.rowattr) ? d.p.rowattr.call(d, e, f, a) : "string" == typeof d.p.rowattr && null != $.jgrid.rowattr && $.isFunction($.jgrid.rowattr[d.p.rowattr]) ? $.jgrid.rowattr[d.p.rowattr].call(d, e, f, a) : {}), !$.isEmptyObject(m)) {
                    ...
                    z = function(a, b, c, e) {
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            var
                                ...
                                O = 0,
                                P = [],
                                Q = parseInt(d.p.rowNum, 10),
                                R = d.p.scroll ? $.jgrid.randId() : 1;
                            if (N > 0 && d.p.page <= 0 && (d.p.page = 1), L && N) {
                                e && (Q *= e + 1);
                                var
                                    S, T = $.isFunction(d.p.afterInsertRow),
                                    U = !1;
                                for (d.p.grouping && (U = d.p.groupingView.groupCollapse === !0, S = $.jgrid.getMethod("groupingPrepare")); N > O;) {
                                    ...
                                    if (J.push(""), G && J.push(s(0, O, d.p.page, d.p.rowNum)), E && J.push(r(A, G, O, !1)), F && J.push(o.call(C, E + G, O + b)), i.repeatitems) {
                                        ...
                                        $.each(x, function(a) {
                                            var
                                                c = W[this];
                                            return c ? (n = c.textContent || c.text, I[d.p.colModel[a + E + F + G].name] = n, void J.push(q(A, n, a + E + F + G, O + b, z, I))) : !1
                                        })
                                    } else
                            ...
                            if (d.p.totaltime = new Date - f, D > 0 && 0 === d.p.records && (d.p.records = N), J = null, d.p.treeGrid === !0) try {
                    ...
                    A = function(a, b, c, e) {
                        ...
                        if (a) {
                            ...
                            var
                                k, l, n, o, p, w, x, z, A, B, C, D, E = $(d),
                                F = 0,
                                G = [],
                                H = d.p.multiselect ? 1 : 0,
                                I = d.p.subGrid === !0 ? 1 : 0,
                                J = d.p.rownumbers === !0 ? 1 : 0,
                                K = u(H + I + J),
                                L = t(h),
                                M = {},
                                N = [],
                                O = d.p.altRows === !0 ? d.p.altclass : "";
                            ...
                            var
                                P, Q, R = parseInt(d.p.rowNum, 10),
                                S = d.p.scroll ? $.jgrid.randId() : 1,
                                T = !1;
                            e && (R *= e + 1), "local" !== d.p.datatype || d.p.deselectAfterSort || (T = !0);
                            var
                                U, V = $.isFunction(d.p.afterInsertRow),
                                W = [],
                                X = !1;
                            for (d.p.grouping && (X = d.p.groupingView.groupCollapse === !0, U = $.jgrid.getMethod("groupingPrepare")); x > l;) {
                                if (o = z[l], C = $.jgrid.getAccessor(o, A), void 0 === C && ("number" == typeof A && null != d.p.colModel[A + H + I + J] && (C = $.jgrid.getAccessor(o, d.p.colModel[A + H + I + J].name)), void 0 === C && (C = S + l, 0 === G.length && g.cell))) {
                                    var
                            ...
                            if (d.p.totaltime = new Date - f, F > 0 && 0 === d.p.records && (d.p.records = x), N = null, d.p.treeGrid === !0) try {
                            ...
                            if (d.p.reccount = F, d.p.treeANode = -1, d.p.userDataOnFooter && E.jqGrid("footerData", "set", d.p.userData, !0), j && (d.p.records = x, d.p.lastpage = Math.ceil(x / R)), c || d.updatepager(!1, !0), j) {
                                for (; x > F && z[F];) {
                                    if (o = z[F], C = $.jgrid.getAccessor(o, A), void 0 === C && ("number" == typeof A && null != d.p.colModel[A + H + I + J] && (C = $.jgrid.getAccessor(o, d.p.colModel[A + H + I + J].name)), void 0 === C && (C = S + F, 0 === G.length && g.cell))) {
                                        var
                    ...
                    B = function() {
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            var
                                t = q.select(),
                                u = parseInt(d.p.rowNum, 10),
                                v = t.length,
                                w = parseInt(d.p.page, 10),
                                x = Math.ceil(v / u),
                                y = {};
                    ...
                    C = function(a, b) {
                        var
                            c, e, f, g, h, i, j, k, l = "",
                            n = d.p.pager ? $.jgrid.jqID(d.p.pager.substr(1)) : "",
                            o = n ? "_" + n : "",
                            p = d.p.toppager ? "_" + d.p.toppager.substr(1) : "";
                    ...
                    H = function(a, b) {
                        var
                            c, e, f, h, i, j, k, l = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>",
                            n = "",
                    ...
                    I = function(a, b) {
                        var
                            ...
                            g = d.p.colModel,
                            h = !1,
                            i = d.p.frozenColumns ? b : d.grid.headers[a].el,
                            j = "";
                    ...
                    J = function(a, b, c, e, f) {
                        if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                            if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) I(b, f);
                            else {
                                if (e) {
                                ...
                                var
                                    g = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null,
                    ...
                    K = function() {
                        var
                            a, b, c, f, g = 0,
                            h = $.jgrid.cell_width ? 0 : m(d.p.cellLayout, 0),
                            i = 0,
                            j = m(d.p.scrollOffset, 0),
                            k = !1,
                            l = 0;
                ...
                var
                    Q, R, S, T, U, V, W, X, Y, Z = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    _ = "",
                    ab = "",
                    bb = [],
                    cb = [],
                ...
                if ("horizontal" === d.p.viewsortcols[1] && (_ = " ui-i-asc", ab = " ui-i-desc"), Q = i ? "class='ui-th-div-ie'" : "", Y = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + _ + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + g + "'></span>", Y += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ab + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>", d.p.multiSort)
                    for (bb = d.p.sortname.split(","), f = 0; f < bb.length; f++) db = $.trim(bb[f]).split(" "), bb[f] = $.trim(db[0]), cb[f] = db[1] ? $.trim(db[1]) : d.p.sortorder || "asc";
                ...
                var
                    jb = $("tr:first", Z),
                    kb = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                ...
                var
                    mb = $("<table class='ui-jqgrid-htable' style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(Z),
                    nb = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1,
                    ob = $("<div class='ui-jqgrid-hbox" + ("rtl" === g ? "-rtl" : "") + "'></div>");
                Z = null, e.hDiv = document.createElement("div"), $(e.hDiv).css({
                    width: e.width + "px"
                }).addClass("ui-state-default ui-jqgrid-hdiv").append(ob), $(ob).append(mb), mb = null, nb && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(j), nb && $(d.p.pager).hide(), H(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function(a) {
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    var
                        b = $(V).hasClass("cbox"),
                        c = $(d).triggerHandler("jqGridBeforeSelectRow", [W[0].id, a]);
                    ...
                    if ("A" !== V.tagName && ("INPUT" !== V.tagName && "TEXTAREA" !== V.tagName && "OPTION" !== V.tagName && "SELECT" !== V.tagName || b)) {
                        if (pb = W[0].id, V = $(V).closest("tr.jqgrow>td"), V.length > 0 && (qb = $.jgrid.getCellIndex(V), rb = $(V).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [pb, qb, rb, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, pb, qb, rb, a)), d.p.cellEdit === !0)
                            if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", pb, !0, a);
                            else
                        if (V.length > 0) {
                            pb = W[0].rowIndex;
                            try {
                        ...
                        if (c)
                            if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", pb, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + pb).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + pb)[d.p.useProp ? "prop" : "attr"]("checked", b));
                            else
                        if (d.p.multiselect && d.p.multiboxonly)
                            if (b) $(d).jqGrid("setSelection", pb, !0, a);
                            else {
                                var
                    ...
                    return d.grid.prevRowHeight && d.p.scroll ? (delete d.p.lastpage, d.grid.populateVisible()) : d.grid.populate(), d.p.inlineNav === !0 && $(d).jqGrid("showAddEditButtons"), !1
                }).dblclick(function(a) {
            ...
            return this.each(function() {
                ...
                if (d.p.frozenColumns === !0 && (c = d.p.id + "_frozen"), void 0 !== a) {
                    if (b = a === d.p.selrow ? d.p.selrow : a, $("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(b)).removeClass("ui-state-highlight").attr("aria-selected", "false"), c && $("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c)).removeClass("ui-state-highlight"), d.p.multiselect) {
                        ...
                        var
                            e = $.inArray($.jgrid.jqID(b), d.p.selarrrow); - 1 !== e && d.p.selarrrow.splice(e, 1)
                    }
                    b = null
                } else
        ...
        addRowData: function(a, b, c, d) {
            ...
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function() {
                var
                    u = this,
                    v = b.length;
                i = u.p.rownumbers === !0 ? 1 : 0, g = u.p.multiselect === !0 ? 1 : 0, h = u.p.subGrid === !0 ? 1 : 0, m || (void 0 !== a ? a = String(a) : (a = $.jgrid.randId(), u.p.keyName !== !1 && (n = u.p.keyName, void 0 !== b[0][n] && (a = b[0][n])))), o = u.p.altclass;
                for (var
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                        ...
                        if (e >= 0 && f) {
                            var
                                g = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0,
                            ...
                            $(a).bind("jqGridResizeStop.setFrozenColumns", function(b, c, d) {
                                ...
                                var
                                    e = $("tr.ui-jqgrid-labels:last th:eq(" + a.p.lastsort + ")", a.grid.fhDiv),
                                    f = $("tr.ui-jqgrid-labels:last th:eq(" + d + ")", a.grid.fhDiv);
    ...
    a.extend(a.jgrid, {
        ...
        info_dialog: function(b, c, d, e) {
            ...
            if (f.buttons.length > 0)
                for (i = 0; i < f.buttons.length; i++) void
            ...
            var
                k = isNaN(f.dataheight) ? f.dataheight : f.dataheight + "px",
        ...
        createEl: function(b, c, d, e, f) {
            ...
            switch (b) {
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function(b) {
                                ...
                                "string" == typeof
                                m && (m = a(a.trim(m)).html()), m && (a(f).append(m), g(f, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (e = d.split(","), e = a.map(e, function(b) {
                                    return a.trim(b)
                ...
                case "button":
                    var
                        z;
                    z = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({
                        width: "98%"
                    }) : c.size || (c.size = 20)), a(h).attr("role", z);
                    break;
                case "image":
                case "file":
                ...
                case "custom":
                    ...
                    try {
                        ...
                        if (!A) throw "e2";
                        A = a(A).addClass("customelement").attr({
                            id: c.id,
                            name: c.name
                        }), a(h).empty().append(A)
                    } catch (p) {
                        var
                            B = a.jgrid.getRegional(i, "errors"),
                            C = a.jgrid.getRegional(i, "edit");
                        "e1" === p && a.jgrid.info_dialog(B.errcap, "function 'custom_element' " + C.msg.nodefined, C.bClose), "e2" === p ? a.jgrid.info_dialog(B.errcap, "function 'custom_element' " + C.msg.novalue, C.bClose) : a.jgrid.info_dialog(B.errcap, "string" == typeof p ? p : p.message, C.bClose)
                    }
            }
            return h
        },
    ...
    a.jgrid.extend({
            ...
            return d = a.extend(!0, {
                        ...
                        if (c.length) {
                            ...
                            a.each(p.p.colModel, function() {
                                if (this.name === e && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (r[e] = this.editoptions.custom_value.call(p, a("#" + a.jgrid.jqID(e), x), "get"), void 0 === r[e]) throw "e1"
                                    } catch (c) {
                            ...
                            switch (a(this).get(0).type) {
                                case "checkbox":
                                    if (a(this).is(":checked")) r[this.name] = a(this).val();
                                    else {
                                        var
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(m) {
                            if (g = this.name, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && this.editable === !0 && "rn" !== g) {
                                ...
                                if (g === d.p.ExpandColumn && d.p.treeGrid === !0) j = a("td[role='gridcell']:eq(" + m + ")", d.rows[q]).text();
                                else {
                                    try {
                                ...
                                if ("_empty" === c && t.defaultValue && (j = a.isFunction(t.defaultValue) ? t.defaultValue.call(p) : t.defaultValue), this.edittype || (this.edittype = "text"), p.p.autoencode && (j = a.jgrid.htmlDecode(j)), l = a.jgrid.createEl.call(p, this.edittype, t, j, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (j = a(l).val(), "select-multiple" === a(l).get(0).type && (j = j.join(","))), "checkbox" === this.edittype && (j = a(l).is(":checked") ? a(l).val() : a(l).attr("offval")), (b[p.p.id].checkOnSubmit || b[p.p.id].checkOnUpdate) && (b[p.p.id]._savedData[g] = j), a(l).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(l).addClass("ui-widget-content ui-corner-all"), C) a(I).find("#" + g).replaceWith(l);
                                    ...
                                    0 === i.length && (i = a("<tr " + k + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + g), a(i).append(s), a(e).append(i), i[0].rp = w), a("td:eq(" + (x - 2) + ")", i[0]).html(void 0 === u.label ? d.p.colNames[m] : u.label), a("td:eq(" + (x - 1) + ")", i[0]).append(u.elmprefix).append(l).append(u.elmsuffix)
                                }
                ...
                i() {
                    var
                        ...
                        n = {},
                        o = p.p.prmNames,
                        q = a(p).triggerHandler("jqGridAddEditBeforeCheckValues", [a(v), t]);
                    q && "object" == typeof
                    q && (r = q), a.isFunction(b[p.p.id].beforeCheckValues) && (q = b[p.p.id].beforeCheckValues.call(p, r, a(v), t), q && "object" == typeof q && (r = q));
                    for (i in
                        r)
                        if (r.hasOwnProperty(i) && (m = a.jgrid.checkValues.call(p, r[i], i), m[0] === !1)) break;
                    if (h(), m[0] && (n = a(p).triggerHandler("jqGridAddEditClickSubmit", [b[p.p.id], r, t]), void 0 === n && a.isFunction(b[p.p.id].onclickSubmit) && (n = b[p.p.id].onclickSubmit.call(p, b[p.p.id], r, t) || {}), m = a(p).triggerHandler("jqGridAddEditBeforeSubmit", [r, a(v), t]), void 0 === m && (m = [!0, "", ""]), m[0] && a.isFunction(b[p.p.id].beforeSubmit) && (m = b[p.p.id].beforeSubmit.call(p, r, a(v), t))), m[0] && !b[p.p.id].processing) {
                        if (b[p.p.id].processing = !0, a("#sData", x + "_2").addClass("ui-state-active"), l = b[p.p.id].url || a(p).jqGrid("getGridParam", "editurl"), f = o.oper, e = "clientArray" === l ? p.p.keyName : o.id, r[f] = "_empty" === a.trim(r[p.p.id + "_id"]) ? o.addoper : o.editoper, r[f] !== o.addoper ? r[e] = r[p.p.id + "_id"] : void 0 === r[e] && (r[e] = r[p.p.id + "_id"]), delete r[p.p.id + "_id"], r = a.extend(r, b[p.p.id].editData, n), p.p.treeGrid === !0) {
                            if (r[f] === o.addoper) {
                            ...
                            for (k in
                                p.p.treeReader)
                                if (p.p.treeReader.hasOwnProperty(k)) {
                                    var
                                        w = p.p.treeReader[k];
                        ...
                        var
                            z = a.extend({
                                ...
                                complete: function(h, i) {
                                    var
                                        k;
                                    if (a("#sData", x + "_2").removeClass("ui-state-active"), r[e] = p.p.idPrefix + r[e], h.status >= 300 && 304 !== h.status ? (m[0] = !1, m[1] = a(p).triggerHandler("jqGridAddEditErrorTextFormat", [h, t]), m[1] = a.isFunction(b[p.p.id].errorTextFormat) ? b[p.p.id].errorTextFormat.call(p, h, t) : i + " Status: '" + h.statusText + "'. Error code: " + h.status) : (m = a(p).triggerHandler("jqGridAddEditAfterSubmit", [h, r, t]), void 0 === m && (m = [!0, "", ""]), m[0] && a.isFunction(b[p.p.id].afterSubmit) && (m = b[p.p.id].afterSubmit.call(p, h, r, t))), m[0] === !1) a(".FormError", v).html(m[1]), a(".FormError", v).show();
                                    else
                                    if (p.p.autoencode && a.each(r, function(b, c) {
                                        ...
                                        }, 500)), (b[p.p.id].checkOnSubmit || b[p.p.id].checkOnUpdate) && (a(v).data("disabled", !1), "_empty" !== b[p.p.id]._savedData[p.p.id + "_id"]))
                                        for (k in
                        ...
                        if (z.url || b[p.p.id].useDataProxy || (a.isFunction(p.p.dataProxy) ? b[p.p.id].useDataProxy = !0 : (m[0] = !1, m[1] += " " + D.nourl)), m[0])
                            if (b[p.p.id].useDataProxy) {
                                var
                ...
                l() {
                    var
                        b;
                    if ("_empty" !== c && void 0 !== p.p.savedRow && p.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow))
                        for (b = 0; b < p.p.savedRow.length; b++)
                            if (p.p.savedRow[b].id === c) {
                ...
                if (p.grid && c) {
                    ...
                    var
                        F, G = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px",
                        H = isNaN(b[a(this)[0].p.id].datawidth) ? b[a(this)[0].p.id].datawidth : b[a(this)[0].p.id].datawidth + "px",
                        I = a("<form name='FormPost' id='" + v + "' class='FormGrid' onSubmit='return false;' style='width:" + H + ";overflow:auto;position:relative;height:" + G + ";'></form>").data("disabled", !1);
                    if (C ? (F = o(b[a(this)[0].p.id].template), q = x) : (F = a("<table id='" + w + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), q = x + "_2"), v = "#" + a.jgrid.jqID(v), a(I).append("<div class='FormError ui-state-error' style='display:none;'></div>"), a(I).append("<div class='tinfo topinfo'>" + b[p.p.id].topinfo + "</div>"), a(p.p.colModel).each(function() {
                        ...
                        }), a(I).append(F), z = a(p).triggerHandler("jqGridAddEditBeforeInitData", [I, t]), void 0 === z && (z = !0), z && a.isFunction(b[p.p.id].beforeInitData) && (z = b[p.p.id].beforeInitData.call(p, I, t)), z !== !1) {
                        l(), f(c, p, F, A);
                        var
                            J = "rtl" === p.p.direction ? !0 : !1,
                            K = J ? "nData" : "pData",
                            L = J ? "pData" : "nData",
                            M = "<a id='" + K + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                            N = "<a id='" + L + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",
                            O = "<a id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                            P = "<a id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>",
                            Q = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + w + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (J ? N + M : M + N) + "</td><td class='EditButton'>" + O + P + "</td></tr>";
                        ...
                        a(p).triggerHandler("jqGridAddEditInitializeForm", [a(v), t]), a.isFunction(b[p.p.id].onInitializeForm) && b[p.p.id].onInitializeForm.call(p, a(v), t), "_empty" !== c && b[p.p.id].viewPagerButtons ? a("#pData,#nData", q).show() : a("#pData,#nData", q).hide(), a(p).triggerHandler("jqGridAddEditBeforeShowForm", [a(v), t]), a.isFunction(b[p.p.id].beforeShowForm) && b[p.p.id].beforeShowForm.call(p, a(v), t), a("#" + a.jgrid.jqID(y.themodal)).data("onClose", b[p.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(y.themodal), {
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(p, "next", a(v), b[1][b[0]]), void 0 !== c && c === !1)) return !1;
                            ...
                            if (-1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(p, "prev", a(v), b[1][b[0]]), void 0 !== c && c === !1)) return !1;
                                if (a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass("ui-state-disabled")) return !1;
        ...
        viewGridRow: function(c, d) {
            ...
            return d = a.extend(!0, {
                ...
                if (j.grid && c) {
                    ...
                    var
                        u = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px",
                    ...
                    if (a(j.p.colModel).each(function() {
                        ...
                        }), a(w).append(x), q && (r = q.call(j, w), void 0 === r && (r = !0)), r !== !1) {
                        f(c, j, x, s);
                        var
                            y = "rtl" === j.p.direction ? !0 : !1,
                            z = y ? "nData" : "pData",
                            A = y ? "pData" : "nData",
        ...
        delGridRow: function(c, d) {
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    var
                        f, g, h, i, j = a.isFunction(b[e.p.id].beforeShowForm),
                    ...
                    if (a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                        ...
                        var
                            s = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px",
                        ...
                        var
                            v = "<a id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                            w = "<a id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
                        if (u += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + p + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + v + "&#160;" + w + "</td></tr></tbody></table>", d.gbox = "#gbox_" + a.jgrid.jqID(m), a.jgrid.createModal(r, u, d, "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]), l && (o = l.call(e, a(u)), void 0 === o && (o = !0)), o === !1) return;
                        a(".fm-button", "#" + p + "_2").hover(function() {
                            ...
                            if (n = {}, a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                ...
                                var
                                    l = a.extend({
                                        ...
                                        complete: function(c, g) {
                                            var
                                                h;
                                            if (a("#dData", "#" + p + "_2").removeClass("ui-state-active"), c.status >= 300 && 304 !== c.status ? (j[0] = !1, j[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : g + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (j = b[e.p.id].afterSubmit.call(e, c, f)), j[0] === !1) a("#DelError>td", "#" + p).html(j[1]), a("#DelError", "#" + p).show();
                                            else {
                                ...
                                if (l.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (j[0] = !1, j[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), j[0])
                ...
                if (!this.p.navGrid) {
                    ...
                    if (n.grid && "string" == typeof b) {
                        ...
                        for (l.cloneToTop && n.p.toppager && (p = 2), o = 0; p > o; o++) {
                            var
                                s, t, u, v = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function() {
                        ...
                        var
                            d, f = this,
                            g = a("<table class='group ui-widget ui-widget-content ui-search-table' style='border:0px none;'><tbody></tbody></table>"),
                            h = "left";
                        ...
                        n.append(p);
                        var
                            q, r = a("<select class='ui-widget-content ui-corner-all'></select>"),
                            s = [];
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                    ...
                    a.each(d.p.colModel, function(c) {
                        var
                            g, h, i, k, l, m, n, o = this,
                            p = "",
                            q = "=",
                            r = a("<th role='columnheader' class='ui-state-default ui-th-" + d.p.direction + "' id='gsh_" + d.p.id + "_" + o.name + "' ></th>"),
                            s = a("<div></div>"),
                            t = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");
                        if (this.hidden === !0 && a(r).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), g = a.extend({}, this.searchoptions || {}, {
                                name: o.index || o.name,
                                id: "gs_" + d.p.idPrefix + o.name,
                                oper: "search"
                            }), this.search) {
                            if (b.searchOperators) {
                                for (h = g.sopt ? g.sopt[0] : "select" === o.stype ? "eq" : b.defaultSearch, i = 0; i < b.odata.length; i++)
                                    if (b.odata[i].oper === h) {
                                        q = b.operands[h] || "";
                                        break
                                    }
                            ...
                            switch (a("td:eq(0)", t).attr("colindex", c).append(p), void 0 === g.clearSearch && (g.clearSearch = !0), g.clearSearch ? (l = b.resetTitle || "Clear Search Value", a("td:eq(2)", t).append("<a title='" + l + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + b.resetIcon + "</a>")) : a("td:eq(2)", t).hide(), this.surl && (g.dataUrl = this.surl), m = "", g.defaultValue && (m = a.isFunction(g.defaultValue) ? g.defaultValue.call(d) : g.defaultValue), n = a.jgrid.createEl.call(d, this.stype, g, m, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(n).css({
                                width: "100%"
                            }).addClass("ui-widget-content ui-corner-all"), a("td:eq(1)", t).append(n), a(s).append(t), this.stype) {
                                case "select":
                        ...
                        var
                            ...
                            g = a.extend({}, d.p.colModel[e].searchoptions || {}),
        ...
        searchGrid: function(b) {
            ...
            return b = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if ("string" == typeof j && (j = a.jgrid.parse(j)), b.recreateFilter === !0 && a("#" + a.jgrid.jqID(i.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id)));
                    else {
                        var
                            k = a("<div><div id='" + f + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(d.p.id)),
                            l = "left",
                            m = "";
                        "rtl" === d.p.direction && (l = "right", m = " style='text-align:left'", k.attr("dir", "rtl"));
                        var
                            n, o, p = a.extend([], d.p.colModel),
                            q = "<a id='" + f + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>",
                            r = "<a id='" + f + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>",
                            s = "",
                            t = "",
                            u = !1,
                            v = -1;
                        ...
                        }), b.multipleGroup === !0 && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + f)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)), b.gbox = "#gbox_" + f, b.layer ? a.jgrid.createModal(i, k, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(i, k, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(i.themodal)).keydown(function(c) {
                            var
                                d = a(c.target);
...
! function(a) {
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        ...
        saveRow: function(b, c, d, e, f, g, h) {
            ...
            var
                v = a.jgrid.getRegional(this, "errors"),
                w = a.jgrid.getRegional(this, "edit"),
                x = a.isFunction(j.beforeSaveRow) ? j.beforeSaveRow.call(k, j, b) : void
            0;
            if (void 0 === x && (x = !0), x) {
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function(b) {
                                ...
                                switch (y.edittype) {
                                    ...
                                    case "custom":
                                        try {
                                            ...
                                            if (r[l] = y.editoptions.custom_value.call(k, a(".customelement", this), "get"), void 0 === r[l]) throw "e2"
                                        } catch (f) {
                        ...
                        try {
                            var
                                z = a(k).jqGrid("getGridRowById", b),
                                A = a.jgrid.findPos(z);
                            a.jgrid.info_dialog(v.errcap, o[1], w.bClose, {
                                left: A[0],
                                top: A[1] + a(z).outerHeight()
                            })
                        } catch (B) {
                            alert(o[1])
                        }
                    ...
                    if (C = k.p.keyName === !1 ? D.id : k.p.keyName, r) {
                        if (r[D.oper] = D.editoper, void 0 === r[C] || "" === r[C]) r[C] = b;
                        else
                        if (p.id !== k.p.idPrefix + r[C]) {
                            var
                                F = a.jgrid.stripPref(k.p.idPrefix, b);
                            if (void 0 !== k.p._index[F] && (k.p._index[r[C]] = k.p._index[F], delete k.p._index[F]), b = k.p.idPrefix + r[C], a(p).attr("id", b), k.p.selrow === E && (k.p.selrow = b), a.isArray(k.p.selarrrow)) {
                                var
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        for (a(p).attr("editable", "0"), I = 0; I < k.p.savedRow.length; I++)
                            if (String(k.p.savedRow[I].id) === String(E)) {
                                n = I;
                                break
                            }
                        ...
                        a(k).jqGrid("progressBar", {
                            ...
                            error: function(c, d, e) {
                                if (a("#lui_" + a.jgrid.jqID(k.p.id)).hide(), a(k).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, e, j]), a.isFunction(j.errorfunc)) j.errorfunc.call(k, b, c, d, e);
                                    ...
                                    try {
                                        a.jgrid.info_dialog(v.errcap, '<div class="ui-state-error">' + f + "</div>", w.bClose, {
                                            buttonalign: "right"
                                        })
                                    } catch (g) {
                                        alert(f)
            ...
            return this.each(function() {
                ...
                if (d.grid) {
                    var
                        ...
                        k = function(b, c) {
                            var
                                e, f, g, h = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                i = a("<tr></tr>");
                        ...
                        l = function(b, c) {
                            var
                                e, f, g, h, i, k, l = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                m = a("<tr></tr>");
                    ...
                    var
                        o = d.rows.length,
                        p = 1;
                    for (void 0 !== c && c > 0 && (p = c, o = c + 1); o > p;) a(d.rows[p]).hasClass("jqgrow") && (d.p.scroll && a(d.rows[p].cells[b]).unbind("click"), a(d.rows[p].cells[b]).bind("click", function() {
                        var
    ...
    a.jgrid.extend({
        ...
        setGroupHeaders: function(b) {
            return b = a.extend({
                ...
                var
                    c, d, e, f, g, h, i, j, k, l, m, n, o, p = this,
                    q = 0,
                    r = p.p.colModel,
                    s = r.length,
                    t = p.grid.headers,
                ...
                for (a(p).prepend(w), e = a("<tr>", {
                    ...
                    if (g = t[c].el, h = a(g), d = r[c], i = {
                        ...
                        f = a("<th>").attr({
                            role: "columnheader"
                        }).addClass("ui-state-default ui-th-column-header ui-th-" + p.p.direction).html(m), n > 0 && f.attr("colspan", String(n)), p.p.headertitles && f.attr("title", f.text()), 0 === n && f.hide(), h.before(f), e.append(g), q = l - 1
                    } else
                        0 === q ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {
                            role: "columnheader"
            ...
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid)
                    for (var
                        ...
                        var
                            s, t = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id),
                            u = d.p._index[t];
        ...
        setTreeGrid: function() {
            return this.each(function() {
                ...
                if (f.p.treeGrid) {
                    ...
                    }), f.p.loadonce && (f.p.treedatatype = "local"), f.p.subGrid = !1, f.p.altRows = !1, f.p.pgbuttons = !1, f.p.pginput = !1, f.p.gridview = !0, null === f.p.rowTotal && (f.p.rowNum = 1e4), f.p.multiselect = !1, f.p.rowList = [], f.p.expColInd = 0, b = "ui-icon-triangle-1-" + ("rtl" === f.p.direction ? "w" : "e"), f.p.treeIcons = a.extend({
                        plus: b,
                ...
                o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (k = d.length, o = d) : (k = 1, o[0] = d), h = [], i = [], h.root = 0, j = 0; k > j; j++) {
                        var
                            p, q = [];
                        for (f = 0; l > f; f++) {
                            if (null == d) g = a.trim(c[f].member) + "_" + c[f].aggregator, p = g, o[0] = p;
                            else {
                                p = d[j].replace(/\s+/g, "");
                                try {
                ...
                p(a) {
                    ...
                    for (d in
                        ...
                        if (a.hasOwnProperty(d)) {
                            ...
                            if (null != a[d] && "object" == typeof a[d] && p(a[d]), "level" === d && a.level > 0) {
                                c = 0;
                                for (b in
                                    a.fields)
